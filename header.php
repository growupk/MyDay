    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu left">
                ...
                <li class="sun active"><a class="faa-parent animated-hover" href="starter.php"><img id="sun-logo" class="faa-spin faa-slow" src="images/sun2.png" alt="logo"><span>MyDay</span></a></li>
